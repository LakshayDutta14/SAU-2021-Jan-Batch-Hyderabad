...
public class EmployeeDemo {
    ...
    public static void main(String[] args) {
        ...
        Employee employee = new Employee("Lakshay", "Dutta");
        Employee employee1 = new Employee("Kashish", "Wattal");
        EmployeeDetails employeeDetails1 = new EmployeeDetails("3463893938","xyz@gmail.com", employee);
        EmployeeDetails employeeDetails2 = new EmployeeDetails("36925849924","akd@gmail.com", employee1);


        Address address1 = new Address("abc", "Shimla", "88933", employee);
        Address address2 = new Address("yddafk", "Dharamshala", "84898", employee);
        Address address3 = new Address("jkdf", "Hamirpur", "363883", employee1);
